...
<html lang="en">
<head>
<title>IG Traders - Contact Us</title>
...
<div class="header">
    ...
    <div class="container">
        ...
        <div class="logo pull-left">
            <h1 ><a href="index.php"><b>T<br>H<br>E</b>IG Grocery<span>The Best of bests</span></a></h1>
        </div>
		...
		<div class=" contact-w3">	
			...
			<div class="col-md-7 contact-left">
				...
				<ul class="contact-list">
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="bimalbruh@gmail.com">Krishnamijju@gmail.com</a></li>
					<li> <i class="fa fa-phone" aria-hidden="true"></i>981234567</li>
				</ul>
				<div id="container">
